...
<div class="login-card mt-4">
  ...
  <% if (fail != null && !fail.isEmpty()) { %>
    <!-- Alert sits INSIDE the card so it matches the card width -->
    <div class="alert alert-danger" role="alert">
      <%= fail %>
    </div>
  <% } %>

  <h4 class="text-center fw-bold text-primary mb-4" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
    Access Your Account
  </h4>
